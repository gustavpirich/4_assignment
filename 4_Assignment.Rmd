...
The higher the values for the hyperparamters, the more volatile the impulse response functions are. In Case 4, were we imppose exxtremely agressive shrinkage, the IRFs become straight lines. The estimated effect sizes are extremely small, to nonexistent. In case 4; a monetary policy shock has no effect on inflation in any period.  

Choosing smaller values for the \lambda_{1}, and controls the tightness of the random walk behaviour. If \lambda_{1} is set to zero, then the VAR becomes a vector of univariate models. If \lambda_{1} goes to infinity, the data and conditional likelihood become more important.  
...
# look at errors
plot.ts(E_OLS[,1], xlab="", ylab="", main="Error delta_oil_production", xaxt="n", lwd=2, cex.main=1.5, cex.lab=2)
axis(1, at=seq(1,395,by=20), labels=time[seq(1,395,by=20)], las=2)
abline(v=seq(1,395,by=20), col="lightgrey", lty=3)
plot.ts(E_OLS[,2], xlab="", ylab="", main="Error real_activity", xaxt="n", lwd=2, cex.main=1.5, cex.lab=2)
axis(1, at=seq(1,395,by=20), labels=time[seq(1,395,by=20)], las=2)
abline(v=seq(1,395,by=20), col="lightgrey", lty=3)
plot.ts(E_OLS[,3], xlab="", ylab="", main="Error real_price_of_oil-bills", xaxt="n", lwd=2, cex.main=1.5, cex.lab=2)
axis(1, at=seq(1,395,by=20), labels=time[seq(1,395,by=20)], las=2)
abline(v=seq(1,395,by=20), col="lightgrey", lty=3)
